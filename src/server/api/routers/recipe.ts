    ...
    const demos = [
      {
        ...
        groups: [
          {
            ...
            ingredients: [
              {
                label: "yellow onions, thinly sliced",
                value: 1.5,
                unit: "KILOGRAM",
                order: 0,
              },
              ...
              {
                label: "baguette, sliced 2cm thick",
                value: 8,
                unit: "NONE",
                order: 7,
              },
        ...
        steps: [
          {
            instruction:
              "Melt butter with olive oil in a large heavy pot over medium-low heat. Add onions and 1 tsp salt. Cook uncovered, stirring every 10 minutes, for 50–60 minutes until deeply golden and jammy.",
            order: 0,
          },
          {
            instruction:
              "Increase heat to medium-high, add wine, and scrape up any browned bits. Cook until wine evaporates, about 3 minutes.",
            order: 1,
          },
          {
            instruction:
              "Add stock, thyme, and bay leaves. Simmer 20 minutes. Season generously with salt and pepper. Remove thyme and bay leaves.",
            order: 2,
          },
          {
            instruction:
          ...
          {
            instruction:
              "Ladle soup into oven-safe bowls, place a crouton on top, and pile on the Gruyère. Broil 3–4 minutes until the cheese is melted and bubbly with brown spots.",
            order: 4,
          },
        ],
      },
      {
        ...
        steps: [
          {
            instruction:
              "Heat olive oil in a wide skillet over medium heat. Cook onion and pepper until soft, about 8 minutes. Add garlic and all spices, stir 1 minute.",
            order: 0,
          },
          {
            instruction:
              "Add crushed tomatoes, season with salt, and simmer 10 minutes until slightly thickened.",
            order: 1,
          },
          {
            instruction:
              "Use a spoon to make 4 wells in the sauce. Crack an egg into each well. Cover and cook on medium-low heat 6–8 minutes, until whites are set but yolks are still runny.",
            order: 2,
          },
          {
            instruction:
              "Scatter feta and parsley over the top. Serve straight from the pan with crusty bread or pita.",
            order: 3,
          },
        ],
      },
      {
        ...
        groups: [
          {
            ...
            ingredients: [
              {
                label: "chicken or pork stock",
                value: 1,
                unit: "LITER",
                order: 0,
              },
              {
                label: "white miso paste",
                value: 3,
                unit: "TABLESPOON",
                order: 1,
              },
          ...
          },
          {
            ...
            ingredients: [
              {
                label: "ramen noodles, fresh or dry",
                value: 200,
                unit: "GRAM",
                order: 0,
              },
        ...
        steps: [
          {
            instruction:
              "Soft-boil eggs: lower into boiling water and cook exactly 7 minutes. Transfer to ice water for 5 minutes, then peel. Set aside.",
            order: 0,
          },
          {
            instruction:
              "In a small bowl, whisk together miso, soy sauce, sesame oil, garlic, ginger, and gochujang into a smooth paste.",
            order: 1,
          },
          {
            instruction:
              "Bring stock to a simmer. Whisk in the miso paste. Do not boil after adding miso or the flavor dulls. Keep on low heat.",
            order: 2,
          },
          {
            instruction:
          ...
          {
            instruction:
              "Fry corn in butter in a small pan over high heat until charred in spots, about 3 minutes.",
            order: 4,
          },
          {
            instruction:
              "Divide noodles between bowls. Ladle hot broth over. Top with halved eggs, charred corn, green onions, nori, and sesame seeds.",
            order: 5,
          },
        ],
      },
      {
        ...
        groups: [
          {
            ...
            ingredients: [
              {
                label: "beef chuck, cut into 4cm cubes",
                value: 1.2,
                unit: "KILOGRAM",
                order: 0,
              },
              {
                label: "lardons or thick-cut bacon, diced",
                value: 200,
                unit: "GRAM",
                order: 1,
              },
              {
                label: "dry red wine (Burgundy or Pinot Noir)",
                value: 750,
                unit: "MILLILITER",
                order: 2,
              },
          ...
          },
          {
            ...
            ingredients: [
              {
                label: "pearl onions, peeled",
                value: 250,
                unit: "GRAM",
                order: 0,
              },
              {
                label: "cremini mushrooms, quartered",
                value: 300,
                unit: "GRAM",
                order: 1,
              },
        ...
        steps: [
          {
            instruction:
              "Pat beef dry, season generously. Brown in batches in a heavy Dutch oven with oil over high heat — don't crowd the pan. Set aside.",
            order: 0,
          },
          {
            instruction:
              "Cook lardons in the same pot until crispy. Add tomato paste and cook 1 minute, then sprinkle in flour and stir 2 minutes.",
            order: 1,
          },
          {
            instruction:
              "Return beef to pot. Add wine, stock, garlic, thyme, and bay leaves. Bring to a boil, then reduce to the lowest simmer. Cover and cook 2.5–3 hours until beef is tender.",
            order: 2,
          },
          {
            instruction:
              "Meanwhile, sauté pearl onions in 1 tbsp butter until golden, about 10 minutes. In another pan, sauté mushrooms in remaining butter over high heat until browned.",
            order: 3,
          },
          {
            instruction:
              "Remove beef. Strain sauce into a saucepan and reduce over high heat until it coats a spoon. Return beef, add onions and mushrooms, simmer together 5 minutes.",
            order: 4,
          },
          {
            instruction:
      ...
      },
      {
        ...
        groups: [
          {
            ...
            ingredients: [
              {
                label: "dried chickpeas, soaked overnight",
                value: 300,
                unit: "GRAM",
                order: 0,
              },
        ...
        steps: [
          {
            instruction:
              "Drain soaked chickpeas well (do not use canned). Pulse in a food processor with parsley, cilantro, onion, garlic, spices, and salt until a coarse, sand-like texture forms. Do not over-process into a paste.",
            order: 0,
          },
          {
            instruction:
              "Add baking powder and mix. Refrigerate the mixture for 30 minutes — this helps it hold together.",
            order: 1,
          },
          {
            instruction:
              "Make tahini sauce: whisk tahini, lemon, garlic, and salt together — it will seize up. Slowly whisk in cold water until smooth and pourable.",
            order: 2,
          },
          {
            instruction:
              "Heat oil to 175°C (350°F) in a deep pan. Form falafel into balls or patties using wet hands or a falafel scoop.",
            order: 3,
          },
          {
            instruction:
              "Fry in batches for 3–4 minutes until deep golden brown. Drain on paper towels.",
            order: 4,
          },
          {
            instruction:
              "Serve in warm pita with tahini sauce, sliced tomato, cucumber, and pickled turnips.",
            order: 5,
          },
        ],
      },
      {
        ...
        steps: [
          {
            instruction:
              "Combine all marinade ingredients with chicken. Cover and refrigerate at least 2 hours, preferably overnight.",
            order: 0,
          },
          {
            instruction:
              "Grill or broil chicken at high heat until charred in spots and cooked through, about 12–15 minutes. Rest 5 minutes, then cut into chunks.",
            order: 1,
          },
          {
            instruction:
              "For the sauce: melt butter in a heavy pot. Cook onion until golden, add garlic and ginger, cook 2 minutes. Add tomatoes and chili powder. Simmer 20 minutes.",
            order: 2,
          },
          {
            instruction:
              "Blend the sauce until completely smooth using an immersion or stand blender. Pass through a fine sieve for an extra silky result.",
            order: 3,
          },
          {
            instruction:
              "Return sauce to pot. Stir in cream, garam masala, and sugar. Simmer 5 minutes. Add chicken and simmer 10 more minutes. Finish with a knob of cold butter stirred in off the heat.",
            order: 4,
          },
      ...
      },
      {
        ...
        groups: [
          ...
          },
          {
            ...
            ingredients: [
              {
                label: "San Marzano tomatoes, crushed by hand",
                value: 400,
                unit: "GRAM",
                order: 0,
              },
              {
                label: "fresh mozzarella, torn",
                value: 250,
                unit: "GRAM",
                order: 1,
              },
        ...
        steps: [
          {
            instruction:
              "Combine flour, yeast, and salt. Add water and olive oil. Mix until shaggy, then knead 10 minutes until smooth and elastic. Divide into 2 balls. Cover and let rise 2 hours at room temperature, or overnight in the fridge.",
            order: 0,
          },
          {
            instruction:
              "Place a baking steel or heavy baking sheet on the top rack. Preheat oven to its maximum temperature (ideally 275°C / 525°F) for at least 45 minutes.",
            order: 1,
          },
          {
            instruction:
              "Season crushed tomatoes with salt only. Do not cook the sauce.",
            order: 2,
          },
          {
            instruction:
              "On a floured surface, stretch (don't roll) a dough ball into a thin 30cm circle by gently pressing from the center outward, leaving a thicker border for the crust.",
            order: 3,
          },
          {
            instruction:
              "Transfer to a lightly floured pizza peel or parchment. Spread a thin layer of tomato sauce. Scatter mozzarella.",
            order: 4,
          },
          {
            instruction:
              "Slide onto the hot steel. Bake 8–12 minutes until the crust is blistered and the cheese is golden in spots. Top with fresh basil and a drizzle of olive oil immediately out of the oven.",
            order: 5,
          },
        ],
      },
      {
        ...
        groups: [
          {
            ...
            ingredients: [
              {
                label: "dark chocolate (70%), chopped",
                value: 200,
                unit: "GRAM",
                order: 0,
              },
              ...
              {
                label: "butter and cocoa, to line ramekins",
                value: 1,
                unit: "NONE",
                order: 7,
              },
        ...
        steps: [
          {
            instruction:
              "Melt chocolate and butter together over a double boiler or in 30-second microwave bursts, stirring between each. Cool slightly.",
            order: 0,
          },
          {
            instruction:
              "Whisk eggs, yolks, and sugar together until slightly pale and thickened, about 2 minutes.",
            order: 1,
          },
          {
            instruction:
          ...
          {
            instruction:
              "Butter 4 ramekins thoroughly and dust with cocoa. Divide batter evenly. At this point you can refrigerate for up to 2 days.",
            order: 3,
          },
          {
            instruction:
              "Preheat oven to 200°C (400°F). Bake ramekins on a tray for 11–12 minutes — the edges should be set but the center should still jiggle.",
            order: 4,
          },
          {
            instruction:
              "Run a knife around the edge, invert onto a plate, and serve immediately with vanilla ice cream or whipped cream.",
            order: 5,
          },
        ],
      },
      {
        ...
        groups: [
          {
            ...
            ingredients: [
              ...
              {
                label: "coconut milk, full-fat",
                value: 800,
                unit: "MILLILITER",
                order: 2,
              },
              {
                label: "chicken thighs, sliced",
                value: 600,
                unit: "GRAM",
                order: 3,
              },
              {
                label: "Thai eggplant, quartered",
                value: 200,
                unit: "GRAM",
                order: 4,
              },
              ...
              {
                label: "palm sugar or brown sugar",
                value: 1,
                unit: "TABLESPOON",
                order: 7,
              },
              ...
              {
                label: "kaffir lime leaves, torn",
                value: 4,
                unit: "NONE",
                order: 9,
              },
              {
                label: "Thai basil leaves",
                value: 0.5,
                unit: "CUP",
                order: 10,
              },
        ...
        steps: [
          {
            instruction:
              "Heat coconut oil in a wok or large pan over high heat. Add curry paste and fry, stirring constantly, for 2 minutes until fragrant and the oil separates.",
            order: 0,
          },
          {
            instruction:
              "Pour in half the coconut milk. Bring to a boil and cook 3 minutes, stirring, until the sauce thickens slightly.",
            order: 1,
          },
          {
            instruction:
              "Add chicken and cook 5 minutes, stirring often, until nearly cooked through.",
            order: 2,
          },
          {
            instruction:
              "Add remaining coconut milk, eggplant, and lime leaves. Simmer 8 minutes.",
            order: 3,
          },
          {
            instruction:
              "Add snap peas, fish sauce, and sugar. Cook 2 more minutes. Taste and balance with lime juice.",
            order: 4,
          },
          {
            instruction:
      ...
      },
      {
        ...
        groups: [
          {
            ...
            ingredients: [
              ...
              {
                label: "active sourdough starter (100% hydration)",
                value: 100,
                unit: "GRAM",
                order: 3,
              },
        ...
        steps: [
          {
            instruction:
              "Mix flours and 350ml water (hold back 25ml). Let rest 45 minutes (autolyse). Mix starter with remaining water, add to dough, then add salt. Squeeze and fold until fully incorporated.",
            order: 0,
          },
          {
            instruction:
              "Bulk fermentation: over the next 4 hours at room temperature (24°C), perform 4 sets of stretch-and-folds, 30 minutes apart. The dough is ready when it's grown ~50% and feels airy.",
            order: 1,
          },
          {
            instruction:
              "Turn dough onto an unfloured surface. Shape into a tight round by folding the edges toward the center, then flipping and dragging toward you to build surface tension.",
            order: 2,
          },
          {
            instruction:
              "Place seam-side up in a floured banneton or bowl lined with a floured cloth. Cover and refrigerate overnight (8–16 hours).",
            order: 3,
          },
          {
            instruction:
              "Preheat oven with a Dutch oven inside to 250°C (480°F) for 45 minutes. Turn cold dough onto parchment, score the top with a razor at a 30° angle.",
            order: 4,
          },
          {
            instruction:
              "Bake covered for 20 minutes, then uncover and bake 25–30 more minutes until the crust is deep mahogany. Cool on a wire rack for at least 1 hour before slicing.",
            order: 5,
          },
        ],
      },
    ...
    .query(async ({ ctx: { db }, input }) => {
      ...
      const rows = await db.$queryRaw<Row[]>`
        SELECT r.id, r."userId", r.title, r.description, r.servings, r."prepTimeMinutes", r."cookTimeMinutes", r.tags, r."imageUrl", r."createdAt", r."updatedAt", r."publishedAt",
          GREATEST(
            CASE WHEN EXISTS(SELECT 1 FROM unnest(r.tags) t WHERE lower(t) = lower(${query})) THEN 10.0 ELSE 0 END,
            MAX(word_similarity(${query}, tag_val)) * 5,
        ...
        HAVING GREATEST(
          CASE WHEN EXISTS(SELECT 1 FROM unnest(r.tags) t WHERE lower(t) = lower(${query})) THEN 1 ELSE 0 END,
